...
public class BattleInterface : MonoBehaviour
{
    ...
    {
        if (battleSystem.playerSpeedBuffActive)
        {
            battleSystem.playerUnit.speed *= 2;
            battleSystem.playerSpeedBuffActive = false;
        }
        else
        {
            battleSystem.playerUnit.speed = battleSystem.savedPlayerSpeed;
        }
    ...
    {
        if ((enemyMaxHP * 0.4) >= enemyCurrentHP)
        {
